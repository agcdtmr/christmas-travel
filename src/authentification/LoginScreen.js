      ...
      <ScrollView>
        <View>
          ...
          <Card.Content style={loginStyle.card}>
            <Formik initialValues={{ email: '', password: '' }} onSubmit={sendValues}>
              ...
              {({ handleSubmit, handleChange, errors, setFieldTouched, touched, values }) => (
                <>
                  <TextInput
                    ...
                    onChangeText={(text) => {
                      handleChange('email'), setEmail(text)
                    }}
                  ...
                  <TextInput
                    ...
                    onChangeText={(text) => {
                      handleChange('password'), setPassword(text)
                    }}
                    onFocus={() => setFieldTouched('password')}
                  />

                  {logInStatusMessage != '' ? <Text>{logInStatusMessage}</Text> : null}
